 ...
 */
 const scoreFeedback = (userScore) => {
   ...
   if (userScore >= 80 && userScore <= 100) {
     ...
     resultFeedback.textContent = `The result of this quiz is not satisfactory, it's clear that you have a limited understanding of Ramadan 2025  Quiz. It's important to put in extra effort and seek assistance to improve your understanding in this subject. I suggest reviewing the material and practicing regularly in order to improve your performance.`;
   }
 };
